      ...
      <header className={`header ${isHome ? 'header-transparent' : ''}`}>
        <div className="header-content">
          <Link to="/" className="logo">
            <img 
              src="https://artcloud.by/wp-content/uploads/2021/04/logo__artcloud.png" 
              alt="ArtCloud" 
            />
          </Link>
      ...
      <footer className="footer">
        <div className="footer-content">
          <div className="footer-logo">
            <img src="https://artcloud.by/wp-content/uploads/2021/04/logo__artcloud.png" alt="ArtCloud" />
